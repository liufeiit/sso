...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left">新建报表</h2>
				<div class="bread-crumb pull-right">
					<a href="/home/index"><i class="icon-home"></i>首页</a><span class="divider">/</span>新建报表
				</div>
						...
						<div class="col-md-12">
							<div class="widget wgreen">
								...
								<div class="widget-content">
									<div class="padd">
										<form class="form-horizontal" role="form" action="/report/create" method="post">
