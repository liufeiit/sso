...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left">编辑SQL</h2>
				<div class="bread-crumb pull-right">
					<a href="/home/index"><i class="icon-home"></i>首页</a><span class="divider">/</span>编辑SQL
				</div>
							...
							<div class="widget wgreen">
								...
								<div class="widget-content">
									<div class="padd">
										...
										<c:if test="${Success}">
											<form class="form-horizontal" role="form" action="/sql/edit" method="post">
												<input type="hidden" name="enter" value="false"></input>
												<input type="hidden" name="sql_id" value="${req.sql_id}"></input>
												<div class="form-group">
