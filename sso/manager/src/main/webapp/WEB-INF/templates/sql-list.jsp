...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left">SQL列表</h2>
				<div class="bread-crumb pull-right">
					<a href="/home/index"><i class="icon-home"></i>首页</a><span class="divider">/</span>SQL列表
				</div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<c:if test="${!Success}">
												...
												<tr><td colspan="4" style="text-align: center;"><a class="btn btn-default btn-sm" href="/sql/create">新建SQL</a></td></tr>
											</c:if>
											<c:if test="${Success}">
												<c:forEach var="sql" items="${ResultData}" varStatus="status">
													<tr>
														<td>${sql.id}</td>
														<td>${sql.name}</td>
														<td>${sql.created}</td>
														<td>
															<div class="btn-group">
																<a class="btn btn-xs btn-default" href="detail/${sql.id}">
																	详情
																</a>
																<a class="btn btn-xs btn-default" href="edit?sql_id=${sql.id}">
																	编辑
																</a>
															</div>
														</td>
