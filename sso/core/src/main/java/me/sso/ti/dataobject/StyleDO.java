 ...
 * 
 * @version 1.0.0
 * @since 2015年2月6日 下午3:24:03
 */
@Entity
@Table(name = "style", catalog = "sso")
public class StyleDO extends BaseDO {
	...
	public int hashCode() {
		...
		result = prime * result + ((floater == null) ? 0 : floater.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (description == null) {
			...
			return false;
		if (floater == null) {
			if (other.floater != null)
				return false;
		} else if (!floater.equals(other.floater))
			return false;
		if (gmt_created == null) {
